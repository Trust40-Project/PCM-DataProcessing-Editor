...
public class RemoveDataprocessingContainerFromUsageModel implements IExternalJavaAction {
	...
	public void execute(Collection<? extends EObject> arg0, Map<String, Object> arg1) {
		DataProcessingContainer dpContianer = (DataProcessingContainer)arg1.get("element");
		...
		DataSpecification dataSpec = Services.getParentOfType(dpContianer, DataSpecification.class);
...
//						System.out.println("applied");
						if(StereotypeAPI.getTaggedValue(aAction, ProfileConstants.TAGGED_VALUE_NAME_DATA_PROCESSING_CONTAINER, ProfileConstants.STEREOTYPE_NAME_DATA_PROCESSING).equals(dpContianer)){
		...
		dataSpec.getDataProcessingContainers().remove(dpContianer);
	}
